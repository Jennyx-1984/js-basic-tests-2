...
describe("Variables en JS", () => {
    ...
    it("Completa todas las variables que faltan para que las operaciones resulten correctamente", () => {
        ...
        expect(f ** g).toBe(1000); //exponencial, es decir, 10^3
        expect(x % 2).toBe(0); //módulo, es decir, el resto de la división entre 2
        expect(y % 2).toBe(1); //módulo, es decir, el resto de la división entre 2
    });
